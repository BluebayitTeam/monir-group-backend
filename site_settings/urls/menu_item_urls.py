...
urlpatterns = [
	...
	path('api/v1/menu_item/without_pagination/all/', views.getAllMenuItemWP),


	path('api/v1/menu_item/nested_menu_item_without_pagination/all/', views.getAllNestedMenuItemWP),
