...
urlpatterns = [
	...
	path('service_slider/', include('site_settings.urls.service_slider_urls')),
	path('portfolio/', include('site_settings.urls.portfolio_urls')),
	path('portfolio_category/', include('site_settings.urls.portfolio_category_urls')),
	path('about/', include('site_settings.urls.about_urls')),
	path('sister_concern/', include('site_settings.urls.sister_concern_urls')),
	path('team/', include('site_settings.urls.team_urls')),
	path('mission_vision/', include('site_settings.urls.mission_vision_urls')),
	path('client/', include('site_settings.urls.client_urls')),
	path('testimonial/', include('site_settings.urls.testimonial_urls')),
	path('gallery/', include('site_settings.urls.gallery_urls')),
	path('profile/', include('site_settings.urls.profile_urls')),
	path('product/', include('site_settings.urls.product_urls')),
	path('contact/', include('site_settings.urls.contact_urls')),
	path('company_message/', include('site_settings.urls.company_message_urls')),


    path('notice/', include('authentication.urls.notice_urls')),
    path('circular/', include('authentication.urls.circular_urls')),
